...
| `OQ-004` | High     | Which MFA factors, enrollment, recovery, replacement, authentication age, and OIDC assurance evidence are acceptable for privileged roles?                                           | `UC-010`, `UC-013`, `QS-SEC-002`                         |
| `OQ-005` | High     | How are local and OIDC identities linked without duplicate Consumers or account takeover?                                                                                            | `UC-001`, `UC-013`, identity ADR                         |
| `OQ-006` | Medium   | Which retention rules apply to financial audit history, pseudonymization, security logs, and backups?                                                                                | `BR-004`, `BR-007`, `UC-013`, `QS-SEC-004`, `QS-OPS-003` |
